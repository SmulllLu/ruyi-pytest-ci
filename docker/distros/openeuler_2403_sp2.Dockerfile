...
RUN dnf upgrade -y && dnf install -y git python3 python3-pexpect python3-pytest coreutils util-linux grep procps bash sudo wget make zstd xz unzip jq glibc-locale-source
