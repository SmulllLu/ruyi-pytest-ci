...
RUN apt-get update && apt-get install -y git python3 python3-pytest python3-pip coreutils util-linux bash sudo wget build-essential zstd locales jq && apt-get clean
