...
RUN apt-get update && apt-get install -y git python3 python3-pexpect python3-pytest coreutils util-linux bash sudo wget build-essential zstd lz4 locales && apt-get clean
